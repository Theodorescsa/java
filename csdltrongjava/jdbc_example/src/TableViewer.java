...
public class TableViewer {
    ...
    final static String jdbcURL = "jdbc:mysql://localhost:3306/my_book"; // Thay đổi StudentDB thành tên database của bạn
    final static String jdbcDriver = "com.mysql.cj.jdbc.Driver"; // Driver cho MySQL
    final static String table = "auth_user"; // Tên bảng
